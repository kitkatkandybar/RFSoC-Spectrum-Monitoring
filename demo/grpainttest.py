...
class grpainttest(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test GR Paint", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test GR Paint")
        ...
        self.settings = Qt.QSettings("GNU Radio", "grpainttest")
...
def main(top_block_cls=grpainttest, options=None):
